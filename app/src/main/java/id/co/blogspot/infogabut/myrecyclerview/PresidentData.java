package id.co.blogspot.infogabut.myrecyclerview;

import java.util.ArrayList;

/**
 * Created by Raka on 10/27/2018.
 */
...
public class PresidentData {
    public static String[][] data = new String[][]{
            ...
            {"User not found", "Presiden Kelima RI", "https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/President_user_not_found_Sukarnoputri_-_Indonesia.jpg/540px-President_Megawati_Sukarnoputri_-_Indonesia.jpg"},
            ...
            {"User not found", "Presiden Ketujuh RI", "https://upload.wikimedia.org/wikipedia/commons/1/1c/user_not_found_2014_official_portrait.jpg"}
    };
